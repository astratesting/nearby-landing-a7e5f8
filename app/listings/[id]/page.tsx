      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Image */}
            <div className="w-full aspect-square bg-gradient-to-br from-coral/10 via-coral/5 to-honey/5 rounded-2xl flex items-center justify-center mb-6 border border-product-charcoal/5 overflow-hidden relative">
              {listing.imageUrl ? (
              ...
              {session?.user?.id && !isOwner && (
                <SaveButton listingId={listing.id} isFavorited={isFavorited} />
              )}
            </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-product-charcoal/5 shadow-sm">
              ...
              <TrustBadge trustScore={listing.seller.trustScore} reviewCount={reviews.length} isVerified={listing.seller.isVerified} />
              <Link
...
function SaveButton({ listingId, isFavorited }: { listingId: string; isFavorited: boolean }) {
  return (
    <form action="/api/favorites" method="POST" className="absolute top-3 right-3 z-10">
      ...
      <button
        ...
        title={isFavorited ? "Remove bookmark" : "Bookmark this listing"}
      >
        <svg
          width="18"
          height="18"
          viewBox="0 0 24 24"
          fill={isFavorited ? "#F97066" : "none"}
          stroke={isFavorited ? "#F97066" : "#1F2937"}
          strokeWidth="2"
          strokeLinecap="round"
